...
const mathProblems=[{id:1,source:"Grade 11 — Semester I Exam, Luong The Vinh High School, 2023–2024",label:"Problem 1",parts:["a) Solve: 2^(x+2) − 2^x = 48.","b) Solve: log₂(x) + log₂(x−2) = 3."],fields:["Answer (a):","Answer (b):"]},{id:2,source:"Grade 11 — Semester I Exam, Nguyen Binh Khiem High School, 2023–2024",label:"Problem 2",parts:["a) Compute: log₄(8) + log₈(32) − log₂(√8).","b) If log₂(a) = 3 and log₂(b) = 5, find log₂(a²b)."],fields:["Answer (a):","Answer (b):"]},{id:3,source:"Grade 11 — Mid-term Exam, Tran Hung Dao High School, 2023–2024",label:"Problem 3",parts:["An arithmetic sequence has u₅ = 21 and u₁₀ = 46.","a) Find u₁ and the common difference d.","b) Find the sum S₂₀."],fields:["Answer (a):","Answer (b) — S₂₀:"]},{id:4,source:"Grade 11 — KSCL Semester I, Ha Noi Department of Education, 2025–2026",label:"Problem 4",parts:["A class has 12 boys and 8 girls.","a) In how many ways can a group of 5 students be chosen if the group must include exactly 2 girls?","b) Four students are randomly selected from the class. Find the probability that at least one girl is selected."],fields:["Answer (a):","Answer (b) — P ="]},{id:5,source:"Grade 11 — KSCL Semester I, Thuan Thanh 2 High School, Bac Ninh, 2025–2026",label:"Problem 5",parts:["a) Verify the identity: sin²(α) + cos²(α) = 1, then find sin α if cos α = −4/5 and π/2 < α < π.","b) Solve: 2sin²(x) − sin(x) − 1 = 0 for x ∈ [0; 2π]."],fields:["Answer (a):","Answer (b) — x ="]}];
