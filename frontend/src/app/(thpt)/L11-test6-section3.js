...
const mathProblems=[{id:1,source:"Grade 11 — Semester I Exam, Chu Van An High School, 2023–2024",label:"Problem 1",parts:["a) Solve: log₅(x+2) + log₅(x−2) = log₅(5).","b) Solve: 4^x − 6·2^x + 8 = 0."],fields:["Answer (a):","Answer (b):"]},{id:2,source:"Grade 11 — Semester I Exam, Ly Tu Trong High School, 2023–2024",label:"Problem 2",parts:["a) Compute: 2^(log₂(3)) + 3^(log₃(5)) − 5^(log₅(2)).","b) Simplify: log₃(√27) + log₉(3) − log₂₇(9)."],fields:["Answer (a):","Answer (b):"]},{id:3,source:"Grade 11 — Mid-term Exam, Le Hong Phong High School, 2023–2024",label:"Problem 3",parts:["The sum of an arithmetic series is S₁₀₀ = 5050.","a) If u₁=1, find d.","b) Find the 50th term u₅₀."],fields:["Answer (a) — d:","Answer (b) — u₅₀:"]},{id:4,source:"Grade 11 — KSCL Semester I, Ha Noi Department of Education, 2025–2026",label:"Problem 4",parts:["An urn contains 4 red and 6 blue balls. Two balls are drawn at random (without replacement).","a) Find the probability that both balls are the same colour.","b) Given that the first ball drawn is red, find the probability that the second ball is also red."],fields:["Answer (a) — P =","Answer (b) — P ="]},{id:5,source:"Grade 11 — KSCL Semester II, Thuan Thanh 2 High School, Bac Ninh, 2025–2026",label:"Problem 5",parts:["a) Evaluate: lim(x→3) (x² − 9)/(x − 3). Then check if f(x) = (x²−9)/(x−3) can be extended to be continuous at x=3.","b) Evaluate: lim(x→0) sin(3x)/(5x) using the standard limit lim(θ→0) sin(θ)/θ = 1."],fields:["Answer (a):","Answer (b):"]}];
