...
export default function Lesson9_GiaTriLuongGiac() {
  ...
  const lessonSlug = "Lesson9_GiaTriLuongGiac";
  const chapterTitle = { vi: "Chương Học Toán 10", en: "Grade 10 Chapter" };
  const lessonTitle = { vi: "Lesson 9: Trig Values (0 to 180 degrees)", en: "Lesson 9: Trig Values (0 to 180 degrees)" };
