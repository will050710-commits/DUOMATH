...
export default function Lesson7_HamSoVaDoThi() {
  ...
  const videoSubtitles = [
  {
    ...
    "words": [
      ...
      },
      {
        ...
        "vi": "hàm số và đồ thị",
        "detail": "<b>functions and graphs</b>: hàm số và đồ thị.",
        "detailTitle": "functions and graphs (hàm số và đồ thị)"
      },
      {
  ...
  },
  {
    ...
    "words": [
      ...
      },
      {
        "text": "domain",
        "vi": "tập xác định",
        "detail": "<b>domain</b>: tập xác định.",
        "detailTitle": "domain (tập xác định)"
      },
      {
      ...
      },
      {
        "text": "range",
        "vi": "tập giá trị",
        "detail": "<b>range</b>: tập giá trị.",
        "detailTitle": "range (tập giá trị)"
      },
      {
  ...
  },
  {
    ...
    "words": [
      ...
      },
      {
        "text": "graph",
        "vi": "đồ thị",
        "detail": "<b>graph</b>: đồ thị.",
        "detailTitle": "graph (đồ thị)"
      },
      {
  ...
  useEffect(() => {
    if (mcDone && user) {
      saveGameResult({
        lesson_slug: "Lesson7_HamSoVaDoThi",
        mode: "mc",
        score: mcScore,
