...
export default function CacBaiLamPage() {
  return (
    <div style={{ width: "100%", background: "#ffffff", display: "flex", justifyContent: "center", minHeight: "105vh" }}>
      <div style={{ width: "1200px", maxWidth: "95%", color: "black", paddingTop: 60, paddingBottom: 80 }}>
        <Link href="/Trangchu" style={{ textDecoration: "none", color: "black", boxShadow: "0 4px 12px rgba(0,0,0,0.1)", padding: "12px 16px",paddingBottom:12, borderRadius: 8, fontSize: 15 }}>
                    ← {("Quay lại")}
                  </Link>
        <h1 style={{ fontSize: 32, fontWeight: "bold", color: "#0B4F5C", marginBottom: 8, letterSpacing: 1,paddingTop: 20 }}>
          Grade 10
        </h1>
          ...
          <div key={si} style={{ marginBottom: 60 }}>
            ...
            {s.chapters.map((ch) => (
              <div key={ch.title} style={{ marginBottom: 40 }}>
                <h2 style={{ fontSize: 20, fontWeight: 600, color: "#333", marginBottom: 20 }}>
                  {ch.title}
                </h2>
                    ...
                    lesson.done ? (
                      ...
                      >
                        ...
                        >
                          ...
                          <div style={{ padding: "16px 20px" }}>
                            ...
                            <div style={{ color: "#555", fontSize: 14, margin: "4px 0 6px" }}>
                              {lesson.title}
                            </div>
                            <div style={{ fontSize: 14, color: "#0B4F5C", fontWeight: 500 }}>
                              Click to learn →
                            </div>
                          </div>
                        </div>
                      ...
                      >
                        <img
                          src="/images/math10.png"
                          alt="Grade 10"
                          style={{ width: "100%", height: 160, objectFit: "cover", filter: "grayscale(60%)" }}
                        />
                        <div style={{ padding: "16px 20px" }}>
                          <div style={{ fontSize: 18, fontWeight: 600, color: "#888" }}>
                            Lesson {idx + 1}
                          </div>
                          <div style={{ color: "#aaa", fontSize: 14, margin: "4px 0 6px" }}>
                            {lesson.title}
                          </div>
            ...
            {si < sections.length - 1 && (
              <div style={{ height: 1, background: "#e0e0e0", margin: "20px 0 40px" }} /> /* Section separator */
            )}
          </div>
        ))}
      </div>
