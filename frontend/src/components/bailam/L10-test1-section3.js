...
const LEGACY_KEY = "reading-test-1_section3";
...
const mathProblems = [
  ...
  },
  {
    ...
    fields: ["Answer (a) — n(Ω):", "Answer (b) — P(A):"],
  },
  {
    id: 4,
    ...
    fields: ["Answer (a) — I and R:", "Answer (b) — tangent equation:"],
  },
  {
    id: 5,
  ...
  return (
    <div style={{ width: "100%", height: "100vh", display: "flex", flexDirection: "column", background: "#f5f5f5" }}>
      ...
      <footer style={{
        ...
        <NavCard href="/L10-test1-section3" label="SECTION 3" active />
        <button
          onClick={submitTest}
          style={{ background: "#c00", color: "white", border: "none", borderRadius: 8, padding: "10px 28px", fontWeight: 600, fontSize: 15, cursor: "pointer" }}
