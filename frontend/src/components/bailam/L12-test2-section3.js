...
const LEGACY_KEY = "reading-test-L12-2_section3";
const SECTION = "section3";
const TEST_KEY = "reading-test-L12-2";
const mathProblems = [{"id":1,"source":"Grade 12 — KSCL Semester I, Le Hong Phong High School, Hanoi, 2025–2026","label":"Problem 1","parts":["a) Study the monotonicity of y = (x+2)/(x−1). Find all asymptotes.","b) The function y = x³ − 3mx has a local maximum at x = −1. Find m."],"fields":["Answer (a) — intervals & asymptotes:","Answer (b) — value of m:"]},{"id":2,"source":"Grade 12 — Mid-term Exam, Chu Van An High School, Hanoi, 2025–2026","label":"Problem 2","parts":["a) Find absolute max and min of f(x) = x³ − 6x² + 9x + 2 on [0, 4].","b) A rectangular field along a straight river requires fencing on 3 sides. Given 120m of fencing, find dimensions for max area."],"fields":["Answer (a) — max & min values:","Answer (b) — dimensions & max area:"]},{"id":3,"source":"Grade 12 — Semester I Exam, Nguyen Hue High School, Hanoi, 2025–2026","label":"Problem 3","parts":["Given A(2,1,−1), B(1,3,2), C(4,0,1) in Oxyz space.","a) Find midpoint M of AB and vector BC.","b) Verify whether points A, B, C are collinear."],"fields":["Answer (a) — M & vector BC:","Answer (b) — collinear status & reasoning:"]},{"id":4,"source":"Grade 12 — KSCL Semester I, Tran Hung Dao High School, Hanoi, 2025–2026","label":"Problem 4","parts":["Given A(1,2,3), B(3,4,5), C(5,6,7) in space.","a) Calculate distances AB and BC.","b) Determine if A, B, C are collinear and state why."],"fields":["Answer (a) — lengths AB & BC:","Answer (b) — collinear check:"]},{"id":5,"source":"Grade 12 — KSCL Semester I, Thuan Thanh 1 High School, Bac Ninh, 2025–2026","label":"Problem 5","parts":["Student heights (cm): 155, 158, 160, 162, 163, 164, 165, 167, 168, 170.","a) Compute the mean height and variance.","b) Find standard deviation and interquartile range (IQR)."],"fields":["Answer (a) — mean & variance:","Answer (b) — std dev & IQR:"]}];
  ...
  return (
    <div style={{ width: "100%", height: "100vh", display: "flex", flexDirection: "column", background: "#f5f5f5" }}>
      <header style={{ background: "#ffffff", borderBottom: "1px solid #e0e0e0", padding: "16px 32px", display: "flex", alignItems: "center", justifyContent: "space-between", boxShadow: "0 2px 8px rgba(0,0,0,0.06)", flexShrink: 0 }}>
        <div><div style={{ fontWeight: "bold", fontSize: 20, color: "#0B4F5C", letterSpacing: 1 }}>DUOSTEAM</div><div style={{ color: "#555", fontSize: 14, marginTop: 2 }}>Bilingual Math Test 2 — Section 3: Short-Answer Math (Grade 12)</div></div>
      ...
      <footer style={{background:"#ffffff",borderTop:"1px solid #e0e0e0",display:"flex",justifyContent:"center",alignItems:"center",gap:16,padding:"12px 32px",height:72,flexShrink:0,boxShadow:"0 -2px 8px rgba(0,0,0,0.05)"}}>
        <NavCard href="/L12-test2-section1" label="SECTION 1" /><NavCard href="/L12-test2-section2" label="SECTION 2" /><NavCard href="/L12-test2-section3" label="SECTION 3" active/>
