...
const LEGACY_KEY = "reading-test-L12-1_section3";
const SECTION = "section3";
const TEST_KEY = "reading-test-L12-1";
const mathProblems = [{"id":1,"source":"Grade 12 — KSCL Semester I, Le Hong Phong High School, Hanoi, 2025–2026","label":"Problem 1","parts":["a) Given f(x) = x³ − 3x² + 4. Find all local extrema of f(x).","b) Determine the intervals of increase and decrease for f(x)."],"fields":["Answer (a) — local max & min:","Answer (b) — increasing/decreasing intervals:"]},{"id":2,"source":"Grade 12 — Mid-term Exam, Chu Van An High School, Hanoi, 2025–2026","label":"Problem 2","parts":["a) Find the absolute maximum and minimum values of f(x) = 2x³ − 9x² + 12x − 1 on [0, 3].","b) An open-top box with a square base has a volume of 32 cm³. Find the base edge length that minimises total surface area."],"fields":["Answer (a) — max and min:","Answer (b) — base length (cm):"]},{"id":3,"source":"Grade 12 — Semester I Exam, Nguyen Hue High School, Hanoi, 2025–2026","label":"Problem 3","parts":["a) Find all asymptotes (vertical, horizontal) of y = (2x+1)/(x−1).","b) Determine critical points and extrema of y = x⁴ − 8x² + 7."],"fields":["Answer (a) — asymptotes:","Answer (b) — extrema values:"]},{"id":4,"source":"Grade 12 — KSCL Semester I, Tran Hung Dao High School, Hanoi, 2025–2026","label":"Problem 4","parts":["Given A(1,0,0), B(0,2,0), C(0,0,3) in Oxyz space.","a) Find components of vectors AB and AC.","b) Compute length |AB| and angle between AB and AC."],"fields":["Answer (a) — vectors AB & AC:","Answer (b) — |AB| & angle/cos:"]},{"id":5,"source":"Grade 12 — KSCL Semester I, Thuan Thanh 2 High School, Bac Ninh, 2025–2026","label":"Problem 5","parts":["A dataset of test scores: 5, 6, 7, 7, 8, 8, 8, 9, 9, 10.","a) Compute the mean (x̄) and variance (S²).","b) Find the standard deviation (S) and interquartile range (IQR)."],"fields":["Answer (a) — mean & variance:","Answer (b) — std dev & IQR:"]}];
  ...
  return (
    <div style={{ width: "100%", height: "100vh", display: "flex", flexDirection: "column", background: "#f5f5f5" }}>
      <header style={{ background: "#ffffff", borderBottom: "1px solid #e0e0e0", padding: "16px 32px", display: "flex", alignItems: "center", justifyContent: "space-between", boxShadow: "0 2px 8px rgba(0,0,0,0.06)", flexShrink: 0 }}>
        <div><div style={{ fontWeight: "bold", fontSize: 20, color: "#0B4F5C", letterSpacing: 1 }}>DUOSTEAM</div><div style={{ color: "#555", fontSize: 14, marginTop: 2 }}>Bilingual Math Test 1 — Section 3: Short-Answer Math (Grade 12)</div></div>
      ...
      <footer style={{background:"#ffffff",borderTop:"1px solid #e0e0e0",display:"flex",justifyContent:"center",alignItems:"center",gap:16,padding:"12px 32px",height:72,flexShrink:0,boxShadow:"0 -2px 8px rgba(0,0,0,0.05)"}}>
        <NavCard href="/L12-test1-section1" label="SECTION 1" /><NavCard href="/L12-test1-section2" label="SECTION 2" /><NavCard href="/L12-test1-section3" label="SECTION 3" active/>
