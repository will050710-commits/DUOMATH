...
const LEGACY_KEY = "reading-test-L12-4_section3";
const SECTION = "section3";
const TEST_KEY = "reading-test-L12-4";
const mathProblems = [{"id":1,"source":"Grade 12 — KSCL Semester II, Le Hong Phong High School, Hanoi, 2025–2026","label":"Problem 1","parts":["a) Find antiderivative F(x) of f(x) = 3x² − 2x + 1 given F(0) = 5.","b) Compute integral: ∫(2x³ − x + 4)dx."],"fields":["Answer (a) — F(x):","Answer (b) — antiderivative:"]},{"id":2,"source":"Grade 12 — Mid-term Exam, Chu Van An High School, Hanoi, 2025–2026","label":"Problem 2","parts":["a) Evaluate definite integral: ∫₁³ (x² + 2x − 1)dx.","b) Evaluate definite integral: ∫₀^(π/2) sin(x)dx."],"fields":["Answer (a) — value:","Answer (b) — value:"]},{"id":3,"source":"Grade 12 — Semester II Exam, Nguyen Hue High School, Hanoi, 2025–2026","label":"Problem 3","parts":["a) Calculate area bounded by y = x² and y = x on interval [0, 1].","b) Calculate area bounded by curve y = 4 − x² and x-axis."],"fields":["Answer (a) — area:","Answer (b) — area:"]},{"id":4,"source":"Grade 12 — KSCL Semester II, Tran Hung Dao High School, Hanoi, 2025–2026","label":"Problem 4","parts":["a) Write plane equation through A(1,2,3) with normal vector n=(2,−1,1).","b) Compute distance from B(3,4,5) to plane 2x − y + z − 3 = 0."],"fields":["Answer (a) — plane equation:","Answer (b) — distance:"]},{"id":5,"source":"Grade 12 — KSCL Semester II, Thuan Thanh 2 High School, Bac Ninh, 2025–2026","label":"Problem 5","parts":["Bag has 4 red and 6 blue balls. Draw 2 balls without replacement.","a) Calculate P(both drawn balls are red).","b) Given 1st ball is red, calculate P(2nd ball is also red)."],"fields":["Answer (a) — probability:","Answer (b) — conditional probability:"]}];
  ...
  return (
    <div style={{ width: "100%", height: "100vh", display: "flex", flexDirection: "column", background: "#f5f5f5" }}>
      <header style={{ background: "#ffffff", borderBottom: "1px solid #e0e0e0", padding: "16px 32px", display: "flex", alignItems: "center", justifyContent: "space-between", boxShadow: "0 2px 8px rgba(0,0,0,0.06)", flexShrink: 0 }}>
        <div><div style={{ fontWeight: "bold", fontSize: 20, color: "#0B4F5C", letterSpacing: 1 }}>DUOSTEAM</div><div style={{ color: "#555", fontSize: 14, marginTop: 2 }}>Bilingual Math Test 4 — Section 3: Short-Answer Math (Grade 12)</div></div>
      ...
      <footer style={{background:"#ffffff",borderTop:"1px solid #e0e0e0",display:"flex",justifyContent:"center",alignItems:"center",gap:16,padding:"12px 32px",height:72,flexShrink:0,boxShadow:"0 -2px 8px rgba(0,0,0,0.05)"}}>
        <NavCard href="/L12-test4-section1" label="SECTION 1" /><NavCard href="/L12-test4-section2" label="SECTION 2" /><NavCard href="/L12-test4-section3" label="SECTION 3" active/>
