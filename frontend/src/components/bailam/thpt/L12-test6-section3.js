...
const LEGACY_KEY = "reading-test-L12-6_section3";
const SECTION = "section3";
const TEST_KEY = "reading-test-L12-6";
const mathProblems = [{"id":1,"source":"Grade 12 — KSCL Semester II, Nguyen Dang Dao High School, Bac Ninh, 2025–2026","label":"Problem 1","parts":["a) Find F(x) = ∫(4x³ − 6x + 2)dx given F(1) = 3.","b) Evaluate definite integral: ∫₀^(π/2) sin(2x)dx."],"fields":["Answer (a) — F(x):","Answer (b) — value:"]},{"id":2,"source":"Grade 12 — Mid-term Exam, Ly Tu Trong High School, Ho Chi Minh City, 2025–2026","label":"Problem 2","parts":["a) Calculate area enclosed by y = x³ and y = x on interval [−1, 1].","b) Calculate area enclosed by y = e^x, y = 0, x = 0, x = 1."],"fields":["Answer (a) — area:","Answer (b) — area:"]},{"id":3,"source":"Grade 12 — Semester II Exam, Tran Hung Dao High School, Hanoi, 2025–2026","label":"Problem 3","parts":["a) Write equation of sphere with center I(1,−2,3) and radius r = 4.","b) Find center and radius of sphere: x²+y²+z²−2x+4y−6z−2 = 0."],"fields":["Answer (a) — sphere equation:","Answer (b) — center & radius:"]},{"id":4,"source":"Grade 12 — KSCL Semester II, Thuan Thanh 2 High School, Bac Ninh, 2025–2026","label":"Problem 4","parts":["Urn has 5 white and 3 black balls. Draw 2 balls sequentially without replacement.","a) Compute P(1st ball white AND 2nd ball black).","b) Compute P(2nd ball drawn is black)."],"fields":["Answer (a) — P(W1 and B2):","Answer (b) — P(2nd is Black):"]},{"id":5,"source":"Grade 12 — KSCL Semester II, Le Hong Phong High School, Hanoi, 2025–2026","label":"Problem 5","parts":["Medical test: Sensitivity=95%, Specificity=90%, Disease Prevalence=2%.","a) Calculate P(random patient tests positive).","b) Given positive test result, calculate P(patient is actually sick)."],"fields":["Answer (a) — P(positive):","Answer (b) — P(sick | positive):"]}];
  ...
  return (
    <div style={{ width: "100%", height: "100vh", display: "flex", flexDirection: "column", background: "#f5f5f5" }}>
      <header style={{ background: "#ffffff", borderBottom: "1px solid #e0e0e0", padding: "16px 32px", display: "flex", alignItems: "center", justifyContent: "space-between", boxShadow: "0 2px 8px rgba(0,0,0,0.06)", flexShrink: 0 }}>
        <div><div style={{ fontWeight: "bold", fontSize: 20, color: "#0B4F5C", letterSpacing: 1 }}>DUOSTEAM</div><div style={{ color: "#555", fontSize: 14, marginTop: 2 }}>Bilingual Math Test 6 — Section 3: Short-Answer Math (Grade 12)</div></div>
      ...
      <footer style={{background:"#ffffff",borderTop:"1px solid #e0e0e0",display:"flex",justifyContent:"center",alignItems:"center",gap:16,padding:"12px 32px",height:72,flexShrink:0,boxShadow:"0 -2px 8px rgba(0,0,0,0.05)"}}>
        <NavCard href="/L12-test6-section1" label="SECTION 1" /><NavCard href="/L12-test6-section2" label="SECTION 2" /><NavCard href="/L12-test6-section3" label="SECTION 3" active/>
