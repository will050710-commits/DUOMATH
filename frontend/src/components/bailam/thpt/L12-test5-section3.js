...
const LEGACY_KEY = "reading-test-L12-5_section3";
const SECTION = "section3";
const TEST_KEY = "reading-test-L12-5";
const mathProblems = [{"id":1,"source":"Grade 12 — KSCL Semester II, Le Hong Phong High School, Hanoi, 2025–2026","label":"Problem 1","parts":["a) Evaluate definite integral: ∫₀¹ (3x² + 4x − 1)dx.","b) Evaluate definite integral: ∫₁⁴ (1/√x)dx."],"fields":["Answer (a) — value:","Answer (b) — value:"]},{"id":2,"source":"Grade 12 — Mid-term Exam, Chu Van An High School, Hanoi, 2025–2026","label":"Problem 2","parts":["a) Calculate area bounded by curve y = x² − 4 and x-axis (y = 0).","b) Calculate area enclosed by curves y = x² and y = 2x."],"fields":["Answer (a) — area:","Answer (b) — area:"]},{"id":3,"source":"Grade 12 — Semester II Exam, Nguyen Hue High School, Hanoi, 2025–2026","label":"Problem 3","parts":["Given points A(1,0,0), B(0,2,0), C(0,0,3).","a) Write equation of plane (ABC).","b) Calculate distance from origin O(0,0,0) to plane (ABC)."],"fields":["Answer (a) — plane equation:","Answer (b) — distance:"]},{"id":4,"source":"Grade 12 — KSCL Semester II, Tran Hung Dao High School, Hanoi, 2025–2026","label":"Problem 4","parts":["a) Write parametric equations of line through A(1,2,3) with direction d=(2,−1,1).","b) Find intersection point of this line with plane z = 0."],"fields":["Answer (a) — line equations:","Answer (b) — intersection point:"]},{"id":5,"source":"Grade 12 — KSCL Semester II, Thuan Thanh 1 High School, Bac Ninh, 2025–2026","label":"Problem 5","parts":["Factory has Machines A (60% output) and B (40% output). Defect rates: A=3%, B=5%.","a) Compute P(random item is defective).","b) Given item is defective, calculate P(it came from Machine A)."],"fields":["Answer (a) — P(defective):","Answer (b) — P(Machine A | defective):"]}];
  ...
  return (
    <div style={{ width: "100%", height: "100vh", display: "flex", flexDirection: "column", background: "#f5f5f5" }}>
      <header style={{ background: "#ffffff", borderBottom: "1px solid #e0e0e0", padding: "16px 32px", display: "flex", alignItems: "center", justifyContent: "space-between", boxShadow: "0 2px 8px rgba(0,0,0,0.06)", flexShrink: 0 }}>
        <div><div style={{ fontWeight: "bold", fontSize: 20, color: "#0B4F5C", letterSpacing: 1 }}>DUOSTEAM</div><div style={{ color: "#555", fontSize: 14, marginTop: 2 }}>Bilingual Math Test 5 — Section 3: Short-Answer Math (Grade 12)</div></div>
      ...
      <footer style={{background:"#ffffff",borderTop:"1px solid #e0e0e0",display:"flex",justifyContent:"center",alignItems:"center",gap:16,padding:"12px 32px",height:72,flexShrink:0,boxShadow:"0 -2px 8px rgba(0,0,0,0.05)"}}>
        <NavCard href="/L12-test5-section1" label="SECTION 1" /><NavCard href="/L12-test5-section2" label="SECTION 2" /><NavCard href="/L12-test5-section3" label="SECTION 3" active/>
