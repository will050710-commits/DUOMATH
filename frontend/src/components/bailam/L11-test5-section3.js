...
const LEGACY_KEY = "reading-test-L11-5_section3";const SECTION="section3";const TEST_KEY="reading-test-L11-5";
const mathProblems=[{id:1,source:"Grade 11 — Semester I Exam, Phan Chau Trinh High School, 2023–2024",label:"Problem 1",parts:["a) Solve: log₂(3x−1) < 3.","b) Solve: 2^x · 3^x = 6^(x+2)."],fields:["Answer (a):","Answer (b):"]},{id:2,source:"Grade 11 — Mid-term Exam, Luong The Vinh High School, 2023–2024",label:"Problem 2",parts:["a) Simplify: log_a(√a³) − 2·log_a(a²) + log_a(a⁵) where a>0, a≠1.","b) If log(2)=0.301, compute log(√200)."],fields:["Answer (a):","Answer (b):"]},{id:3,source:"Grade 11 — Semester I Exam, Tran Dai Nghia High School, 2023–2024",label:"Problem 3",parts:["An arithmetic sequence satisfies u₁+u₃+u₅=21 and u₁·u₃·u₅=105.","a) Find u₁ and d.","b) Find S₁₀."],fields:["Answer (a):","Answer (b) — S₁₀:"]},{id:4,source:"Grade 11 — Semester I Exam, Nguyen Thi Minh Khai High School, 2023–2024",label:"Problem 4",parts:["In a geometric sequence, u₁=4, u₂=−8.","a) Find q and write the general term uₙ.","b) Find S₁₀."],fields:["Answer (a):","Answer (b) — S₁₀:"]},{id:5,source:"Grade 11 — End-of-Year Exam, Nguyen Trai High School, 2023–2024",label:"Problem 5",parts:["a) Find the negation of: ∀x∈ℝ: x²+2x+2 > 0.","b) Solve: 9^x − 10·3^x + 9 = 0."],fields:["Answer (a):","Answer (b):"]}];
