...
"[project]/duosteam/src/components/Cacbaitoan10/Lesson21_DauTamThucBacHai.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Lesson21_DauTamThucBacHai() {
    ...
    const mcQ = [
        {
            q: t("Tam thức f(x)=ax²+bx+c (a>0) có Δ>0. Dấu của f(x) khi x∈(x₁,x₂)?", "f(x)=ax²+bx+c (a>0), Δ>0. Sign of f(x) for x∈(x₁,x₂)?"),
            o: [
                t("Dương", "Positive"),
                t("Âm", "Negative"),
                t("Bằng 0", "Zero"),
        ...
        {
            q: t("f(x)=x²−5x+6. Dấu của f(x) khi x∈(2,3)?", "f(x)=x²−5x+6. Sign for x∈(2,3)?"),
            o: [
                t("Dương", "Positive"),
                t("Âm", "Negative"),
                "=0",
        ...
        },
        {
            ...
            a: 1,
            ex: t("Δ=b²−4ac=16−4·(−1)·(−5)=16−20=−4<0.", "Δ=16−20=−4<0.")
        },
        {
            q: t("f(x)=ax²+bx+c (a>0), Δ<0. Dấu của f(x)?", "f(x)=ax²+bx+c, a>0, Δ<0. Sign?"),
            o: [
                t("Luôn âm", "Always negative"),
                t("Luôn dương", "Always positive"),
                t("Đổi dấu", "Changes sign"),
                t("Bằng 0", "Always zero")
            ],
            a: 1,
            ex: t("a>0, Δ<0: parabol không cắt Ox, luôn nằm trên Ox → f(x)>0 với mọi x.", "a>0, Δ<0: parabola above Ox → f(x)>0 for all x.")
        },
        {
            q: t("f(x)=2x²−8x+8. Tập nghiệm f(x)≤0 là?", "f(x)=2x²−8x+8. Solution set of f(x)≤0?"),
            o: [
                "{2}",
                "(−∞,2]",
                "[2,+∞)",
    ...
    const tfC = [
        {
            s: t("Nếu a>0 và Δ<0, thì f(x)=ax²+bx+c>0 với mọi x.", "If a>0 and Δ<0, then f(x)>0 for all x."),
            a: true,
            ex: t("ĐÚNG — parabol mở lên, không cắt Ox → luôn dương.", "TRUE — opens up, no x-intercepts → always positive.")
        },
        {
            s: t("f(x)=x²−4x+4=(x−2)² luôn không âm.", "f(x)=(x−2)² is always non-negative."),
            a: true,
            ex: t("ĐÚNG — bình phương ≥0, bằng 0 khi x=2.", "TRUE — square ≥0, equals 0 when x=2.")
        },
        {
            s: t("Nếu a<0 và Δ>0, f(x)>0 với x ngoài khoảng (x₁,x₂).", "If a<0 and Δ>0, f(x)>0 outside (x₁,x₂)."),
            a: false,
            ex: t("SAI — a<0: f(x)>0 trong khoảng (x₁,x₂), âm ngoài khoảng.", "FALSE — a<0: f>0 INSIDE (x₁,x₂), negative outside.")
        },
        {
            s: t("Tam thức bậc hai có thể có 0, 1 hoặc 2 nghiệm thực.", "A quadratic trinomial can have 0, 1, or 2 real roots."),
            a: true,
            ex: t("ĐÚNG — tùy thuộc Δ<0 (vô nghiệm), Δ=0 (nghiệm kép), Δ>0 (2 nghiệm).", "TRUE — depends on sign of Δ.")
        },
        {
            s: t("Nếu Δ=0, tam thức có nghiệm kép x₀=−b/(2a) và f(x)≥0 khi a>0.", "If Δ=0, f has double root x₀=−b/2a and f(x)≥0 for a>0."),
            a: true,
            ex: t("ĐÚNG — Δ=0: f(x)=a(x−x₀)²≥0 khi a>0.", "TRUE — Δ=0: f=a(x−x₀)²≥0 for a>0.")
        }
    ];
    const fQ = [
        {
            id: "f1",
            tp: t("f(x)=ax²+bx+c, a>0, Δ>0. Dấu f(x)<0 khi x thuộc ___.", "f(x)=ax²+bx+c, a>0, Δ>0. f(x)<0 when x ∈ ___."),
            ans: "(x₁,x₂)",
            alt: [
                "(x1,x2)",
                "x1x2",
        ...
        {
            id: "f3",
            tp: t("f(x)=x²−6x+9=(x−___)²", "f(x)=x²−6x+9=(x−___)²"),
            ans: "3",
            alt: [
                "3"
            ],
    ...
    const tabs = [
        ...
        [
            "k2",
            "📖",
            t("2. Bảng Xét Dấu", "2. Sign Table")
        ],
        [
            "k3",
            "📖",
            t("3. Các Trường Hợp", "3. All Cases")
        ],
        [
            "th",
            "✏️",
            ...
            children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$duosteam$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_64d5eeabc3e5d7da937e2327328eb8d4$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$duosteam$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_64d5eeabc3e5d7da937e2327328eb8d4$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: t("Chương VII · Bất Phương Trình Bậc Hai Một Ẩn", "Chapter VII · Quadratic Inequalities in One Variable")
                                }, void 0, false, {
                                    fileName: "[project]/duosteam/src/components/Cacbaitoan10/Lesson21_DauTamThucBacHai.js",
                                    lineNumber: 99,
                                    columnNumber: 11
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$duosteam$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_64d5eeabc3e5d7da937e2327328eb8d4$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: t("Bài 21: Dấu của Tam Thức Bậc Hai", "Lesson 21: Sign of a Quadratic Trinomial")
                                }, void 0, false, {
                                    fileName: "[project]/duosteam/src/components/Cacbaitoan10/Lesson21_DauTamThucBacHai.js",
                                    lineNumber: 100,
                                    columnNumber: 11
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$duosteam$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_64d5eeabc3e5d7da937e2327328eb8d4$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$duosteam$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_64d5eeabc3e5d7da937e2327328eb8d4$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("em", {
                                            children: t("Hãy tính Δ và tìm 2 nghiệm của f(x) trước khi học lý thuyết.", "Try computing Δ and the two roots of f(x) before studying the theory.")
                                        }, void 0, false, {
                                            fileName: "[project]/duosteam/src/components/Cacbaitoan10/Lesson21_DauTamThucBacHai.js",
                                            lineNumber: 129,
                                            columnNumber: 42
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$duosteam$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_64d5eeabc3e5d7da937e2327328eb8d4$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$duosteam$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_64d5eeabc3e5d7da937e2327328eb8d4$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(SH, {
                            icon: "📖",
                            title: t("1. Tam Thức Bậc Hai", "1. Quadratic Trinomial")
                        }, void 0, false, {
                            fileName: "[project]/duosteam/src/components/Cacbaitoan10/Lesson21_DauTamThucBacHai.js",
                            lineNumber: 135,
                            columnNumber: 9
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$duosteam$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_64d5eeabc3e5d7da937e2327328eb8d4$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$duosteam$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_64d5eeabc3e5d7da937e2327328eb8d4$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: t("Tam thức bậc hai (theo x) là biểu thức dạng f(x) = ax² + bx + c, trong đó a ≠ 0. Biệt thức Δ = b² − 4ac quyết định số nghiệm và dấu của f(x).", "A quadratic trinomial in x has the form f(x)=ax²+bx+c, a≠0. The discriminant Δ=b²−4ac determines the number of roots and sign of f(x).")
                                }, void 0, false, {
                                    fileName: "[project]/duosteam/src/components/Cacbaitoan10/Lesson21_DauTamThucBacHai.js",
                                    lineNumber: 138,
                                    columnNumber: 11
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$duosteam$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_64d5eeabc3e5d7da937e2327328eb8d4$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        "Δ > 0 → 2 nghiệm phân biệt x₁,x₂ (x₁ < x₂)",
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$duosteam$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_64d5eeabc3e5d7da937e2327328eb8d4$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("br", {}, void 0, false, {
                                            fileName: "[project]/duosteam/src/components/Cacbaitoan10/Lesson21_DauTamThucBacHai.js",
                                            lineNumber: 141,
                                            columnNumber: 61
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$duosteam$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_64d5eeabc3e5d7da937e2327328eb8d4$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$duosteam$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_64d5eeabc3e5d7da937e2327328eb8d4$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(SH, {
                            icon: "📖",
                            title: t("2. Bảng Xét Dấu (Định Lý)", "2. Sign Table (Theorem)")
                        }, void 0, false, {
                            fileName: "[project]/duosteam/src/components/Cacbaitoan10/Lesson21_DauTamThucBacHai.js",
                            lineNumber: 150,
                            columnNumber: 9
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$duosteam$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_64d5eeabc3e5d7da937e2327328eb8d4$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$duosteam$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_64d5eeabc3e5d7da937e2327328eb8d4$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        "📌 ",
                                        t("Định lý về dấu tam thức bậc hai (a>0, Δ>0, nghiệm x₁<x₂):", "Sign theorem (a>0, Δ>0, roots x₁<x₂):")
                                    ]
                                }, void 0, true, {
                                    fileName: "[project]/duosteam/src/components/Cacbaitoan10/Lesson21_DauTamThucBacHai.js",
                                    lineNumber: 152,
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$duosteam$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_64d5eeabc3e5d7da937e2327328eb8d4$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$duosteam$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_64d5eeabc3e5d7da937e2327328eb8d4$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(SH, {
                            icon: "📖",
                            title: t("3. Bảng Tổng Hợp 6 Trường Hợp", "3. All 6 Cases Summary")
                        }, void 0, false, {
                            fileName: "[project]/duosteam/src/components/Cacbaitoan10/Lesson21_DauTamThucBacHai.js",
                            lineNumber: 175,
                            columnNumber: 9
                            ...
                            children: [
                                {
                                    cond: "a>0, Δ>0",
                                    roots: t("x₁<x₂", "x₁<x₂"),
                                    sign: t("+ ngoài | − trong | + ngoài", "+outside | −inside | +outside"),
                                    pos: t("x<x₁ hoặc x>x₂", "x<x₁ or x>x₂"),
                                    neg: t("x₁<x<x₂", "x₁<x<x₂"),
                                    c: "#1e8449",
                                    bg: "#eafaf1"
                                },
                                {
                                    cond: "a>0, Δ=0",
                                    roots: "x₀",
                                    sign: t("≥0 mọi x, =0 tại x₀", "≥0 for all x, =0 at x₀"),
                                    pos: t("mọi x≠x₀", "all x≠x₀"),
                                    neg: t("∅ (không âm)", "∅ (not negative)"),
                                    c: "#1a5276",
                                    bg: "#eaf4fb"
                                },
                                {
                                    cond: "a>0, Δ<0",
                                    roots: t("Vô nghiệm", "No roots"),
                                    sign: t(">0 mọi x", ">0 for all x"),
                                    pos: "ℝ",
                                    neg: "∅",
                                    c: "#856404",
                                    bg: "#fff3cd"
                                ...
                                },
                                {
                                    ...
                                    roots: "x₀",
                                    sign: t("≤0 mọi x, =0 tại x₀", "≤0 for all x, =0 at x₀"),
                                    pos: t("∅ (không dương)", "∅ (not positive)"),
                                    neg: t("mọi x≠x₀", "all x≠x₀"),
                                    c: "#6c3483",
                                    bg: "#f5eef8"
                                },
                                {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$duosteam$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_64d5eeabc3e5d7da937e2327328eb8d4$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                {
                                    id: "e1",
                                    q: t("Xét dấu f(x) = x² − 3x + 2.", "Determine the sign of f(x)=x²−3x+2."),
                                    a: [
                                ...
                                {
                                    id: "e2",
                                    q: t("Xét dấu f(x) = −2x² + 4x − 3.", "Sign of f(x)=−2x²+4x−3."),
                                    a: [
                                        t("a=−2<0; Δ=16−24=−8<0", "a=−2<0; Δ=−8<0"),
                                        t("Δ<0 và a<0 → f(x)<0 với mọi x ∈ ℝ", "Δ<0 and a<0 → f(x)<0 for all x∈ℝ")
                                    ]
                                },
                                {
                                    id: "e3",
                                    q: t("Tìm x để f(x)=x²−4x+4≥0.", "Find x such that x²−4x+4≥0."),
                                    a: [
                                        t("f(x)=(x−2)²", "f(x)=(x−2)²"),
                                        t("Δ=16−16=0; x₀=2", "Δ=0; double root x₀=2"),
                                        t("(x−2)²≥0 với mọi x → nghiệm: x∈ℝ", "(x−2)²≥0 for all x → solution: x∈ℝ")
                                    ]
                                }
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$duosteam$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_64d5eeabc3e5d7da937e2327328eb8d4$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        t("Bài 21 / Chương VII", "Lesson 21 / Chapter VII")
                    ]
                }, void 0, true, {
                    fileName: "[project]/duosteam/src/components/Cacbaitoan10/Lesson21_DauTamThucBacHai.js",
                    lineNumber: 235,
...
//# sourceMappingURL=duosteam_src_components_76c7d558._.js.map