...
"[project]/duosteam/src/components/Cacbaitoan10/Lesson10_DinhLiCosin.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Lesson11_DinhLiCosin() {
    ...
    const mcQ = [
        {
            q: t("Định lí Côsin: a² = ?", "Law of Cosines: a² = ?"),
            o: [
                "b²+c²+2bc·cosA",
                "b²+c²−2bc·cosA",
                "b²−c²+2bc·cosA",
            ...
            a: 1,
            ex: t("a²=b²+c²−2bc·cosA — dấu trừ trước 2bc·cosA.", "a²=b²+c²−2bc·cosA — note the minus sign before 2bc·cosA.")
        },
        {
            q: t("Tam giác ABC: b=3, c=4, A=90°. Tính a.", "Triangle: b=3, c=4, A=90°. Find a."),
            o: [
                "5",
                "√7",
                "7",
            ...
            a: 0,
            ex: t("cosA=cos90°=0 → a²=9+16=25 → a=5.", "cos90°=0 → a²=9+16=25 → a=5.")
        },
        {
            q: t("cosA = (b²+c²−a²)/(2bc) dùng để làm gì?", "cosA=(b²+c²−a²)/(2bc) is used to?"),
            o: [
                t("Tính cạnh a", "Find side a"),
                t("Tính góc A từ 3 cạnh", "Find angle A from 3 sides"),
                t("Tính diện tích", "Find area"),
                t("Tính chu vi", "Find perimeter")
            ],
            a: 1,
            ex: t("Công thức ngược của Đ.L.Côsin để tính góc khi đã biết 3 cạnh.", "Inverse Law of Cosines to find angle when all 3 sides are known.")
        },
        {
            q: t("Tam giác: a=3, b=4, c=5. cosC = ?", "Triangle: a=3, b=4, c=5. cosC = ?"),
            o: [
                "0",
                "1/2",
                "−1/2",
            ...
            a: 0,
            ex: t("cosC=(a²+b²−c²)/(2ab)=(9+16−25)/24=0 → C=90°.", "cosC=(9+16−25)/24=0 → C=90°.")
        },
        {
            q: t("Tam giác đều cạnh a. cosA = ?", "Equilateral triangle side a. cosA = ?"),
            o: [
                "0",
                "1",
                "1/2",
            ...
            a: 2,
            ex: t("cosA=(a²+a²−a²)/(2a²)=a²/(2a²)=1/2 → A=60°.", "cosA=a²/(2a²)=1/2 → A=60°.")
        }
    ];
    const tfC = [
        {
            s: t("Định lí Pythagore là trường hợp đặc biệt của Định lí Côsin khi góc C=90°.", "The Pythagorean theorem is a special case of the Law of Cosines when C=90°."),
            a: true,
            ex: t("ĐÚNG — cosC=cos90°=0 → c²=a²+b².", "TRUE — cos90°=0 → c²=a²+b².")
        },
        {
            s: t("Định lí Côsin: a²=b²+c²+2bc·cosA.", "Law of Cosines: a²=b²+c²+2bc·cosA."),
            a: false,
            ex: t("SAI — dấu trừ: a²=b²+c²−2bc·cosA.", "FALSE — it's minus: a²=b²+c²−2bc·cosA.")
        },
        {
            s: t("Nếu tam giác có cosA<0 thì A là góc tù.", "If cosA<0 in a triangle then A is obtuse."),
            a: true,
            ex: t("ĐÚNG — cosA<0 ⟺ 90°<A<180°.", "TRUE — cosA<0 ⟺ 90°<A<180°.")
        },
        {
            s: t("Từ 3 cạnh bất kỳ ta luôn tính được 3 góc bằng Định lí Côsin.", "From any 3 sides we can always find all 3 angles using the Law of Cosines."),
            a: false,
            ex: t("SAI — 3 cạnh phải thỏa bất đẳng thức tam giác: tổng hai cạnh > cạnh còn lại.", "FALSE — the 3 sides must satisfy the triangle inequality first.")
        },
        {
            s: t("Trong tam giác đều, Định lí Côsin cho cosA=1/2.", "In an equilateral triangle, the Law of Cosines gives cosA=1/2."),
            a: true,
            ex: t("ĐÚNG — cosA=(a²+a²−a²)/(2a²)=1/2 → A=60°.", "TRUE — cosA=1/2 → A=60°.")
        }
    ];
    const fQ = [
        {
            id: "f1",
            tp: t("Định lí Côsin: a² = b² + c² − ___ · cosA", "Law of Cosines: a² = b² + c² − ___ · cosA"),
            ans: "2bc",
            alt: [
                "2bc"
            ],
        ...
        {
            id: "f2",
            tp: t("cosC = (a² + b² − c²) / ___", "cosC = (a² + b² − c²) / ___"),
            ans: "2ab",
            alt: [
                "2ab"
            ],
        ...
        {
            id: "f3",
            tp: t("Khi C=90°, Định lí Côsin cho: c² = a² + ___", "When C=90°, Law of Cosines gives: c² = a² + ___"),
            ans: "b²",
            alt: [
                "b²",
                "b^2"
    ...
    const tabs = [
        ...
        [
            "k1",
            "📖",
            t("1. Định Lí", "1. The Law")
        ],
        [
            "k2",
            "📖",
            t("2. Tính Góc", "2. Finding Angles")
        ],
        [
            "k3",
            "📖",
            t("3. Ứng Dụng", "3. Applications")
        ],
        [
            "th",
            "✏️",
            ...
            children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$duosteam$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_64d5eeabc3e5d7da937e2327328eb8d4$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$duosteam$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_64d5eeabc3e5d7da937e2327328eb8d4$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: t("Bài 11: Định Lí Côsin", "Lesson 11: Law of Cosines")
                                }, void 0, false, {
                                    fileName: "[project]/duosteam/src/components/Cacbaitoan10/Lesson10_DinhLiCosin.js",
                                    lineNumber: 104,
                                    columnNumber: 11
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$duosteam$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_64d5eeabc3e5d7da937e2327328eb8d4$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$duosteam$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_64d5eeabc3e5d7da937e2327328eb8d4$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("em", {
                                            children: t("Định lí Pythagore có liên hệ gì với Định lí Côsin không?", "How is the Pythagorean theorem related to the Law of Cosines?")
                                        }, void 0, false, {
                                            fileName: "[project]/duosteam/src/components/Cacbaitoan10/Lesson10_DinhLiCosin.js",
                                            lineNumber: 137,
                                            columnNumber: 42
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$duosteam$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_64d5eeabc3e5d7da937e2327328eb8d4$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$duosteam$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_64d5eeabc3e5d7da937e2327328eb8d4$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(SH, {
                            icon: "📖",
                            title: t("1. Phát Biểu Định Lí Côsin", "1. Statement of the Law of Cosines")
                        }, void 0, false, {
                            fileName: "[project]/duosteam/src/components/Cacbaitoan10/Lesson10_DinhLiCosin.js",
                            lineNumber: 143,
                            columnNumber: 9
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$duosteam$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_64d5eeabc3e5d7da937e2327328eb8d4$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$duosteam$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_64d5eeabc3e5d7da937e2327328eb8d4$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: t("Trong tam giác ABC với a, b, c là các cạnh đối diện với góc A, B, C:", "In triangle ABC with sides a, b, c opposite angles A, B, C:")
                                }, void 0, false, {
                                    fileName: "[project]/duosteam/src/components/Cacbaitoan10/Lesson10_DinhLiCosin.js",
                                    lineNumber: 146,
                                    columnNumber: 11
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$duosteam$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_64d5eeabc3e5d7da937e2327328eb8d4$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$duosteam$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_64d5eeabc3e5d7da937e2327328eb8d4$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(SH, {
                            icon: "📖",
                            title: t("2. Tính Góc Khi Biết 3 Cạnh", "2. Finding Angles from 3 Sides")
                        }, void 0, false, {
                            fileName: "[project]/duosteam/src/components/Cacbaitoan10/Lesson10_DinhLiCosin.js",
                            lineNumber: 160,
                            columnNumber: 9
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$duosteam$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_64d5eeabc3e5d7da937e2327328eb8d4$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$duosteam$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_64d5eeabc3e5d7da937e2327328eb8d4$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: t("Rút ra công thức tính góc:", "Rearranging for angles:")
                                }, void 0, false, {
                                    fileName: "[project]/duosteam/src/components/Cacbaitoan10/Lesson10_DinhLiCosin.js",
                                    lineNumber: 162,
                                    columnNumber: 11
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$duosteam$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_64d5eeabc3e5d7da937e2327328eb8d4$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                {
                                    label: t("cosA > 0", "cosA > 0"),
                                    note: t("→ A nhọn (A < 90°)", "→ A is acute (A < 90°)"),
                                    bg: "#eafaf1",
                                    c: "#1e8449"
                                },
                                {
                                    label: t("cosA = 0", "cosA = 0"),
                                    note: t("→ A = 90° (vuông)", "→ A = 90° (right angle)"),
                                    bg: "#eaf4fb",
                                    c: "#1a5276"
                                },
                                {
                                    label: t("cosA < 0", "cosA < 0"),
                                    note: t("→ A tù (A > 90°)", "→ A is obtuse (A > 90°)"),
                                    bg: "#fdf2f2",
                                    c: "#922b21"
                                }
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$duosteam$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_64d5eeabc3e5d7da937e2327328eb8d4$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$duosteam$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_64d5eeabc3e5d7da937e2327328eb8d4$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(SH, {
                            icon: "📖",
                            title: t("3. Khi Nào Dùng Định Lí Côsin?", "3. When to Use the Law of Cosines?")
                        }, void 0, false, {
                            fileName: "[project]/duosteam/src/components/Cacbaitoan10/Lesson10_DinhLiCosin.js",
                            lineNumber: 184,
                            columnNumber: 9
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$duosteam$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_64d5eeabc3e5d7da937e2327328eb8d4$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                {
                                    case: t("Biết 2 cạnh + góc xen giữa (SAS)", "2 sides + included angle (SAS)"),
                                    use: t("→ Tính cạnh thứ 3: a²=b²+c²−2bc·cosA", "→ Find 3rd side: a²=b²+c²−2bc·cosA"),
                                    bg: "#eafaf1",
                                    c: "#1e8449"
                                },
                                {
                                    case: t("Biết 3 cạnh (SSS)", "3 sides known (SSS)"),
                                    use: t("→ Tính cả 3 góc bằng công thức cosine ngược", "→ Find all 3 angles using inverse cosine"),
                                    bg: "#eaf4fb",
                                    c: "#1a5276"
                                },
                                {
                                    case: t("Kiểm tra dạng tam giác", "Check triangle type"),
                                    use: t("→ c²=a²+b² (vuông), <(nhọn), >(tù)", "→ c²=a²+b² (right), < (acute), > (obtuse)"),
                                    bg: "#fff3cd",
                                    c: "#856404"
                                }
                            ].map((card, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$duosteam$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_64d5eeabc3e5d7da937e2327328eb8d4$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("article", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$duosteam$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_64d5eeabc3e5d7da937e2327328eb8d4$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                {
                                    id: "e1",
                                    q: t("Tam giác ABC: b=5, c=7, A=60°. Tính cạnh a.", "Triangle ABC: b=5, c=7, A=60°. Find side a."),
                                    a: [
                                        t("a²=b²+c²−2bc·cosA=25+49−2·5·7·cos60°", "a²=25+49−2·5·7·cos60°"),
                                        t("=74−70·(1/2)=74−35=39", "=74−35=39"),
                                        t("→ a=√39≈6.24", "→ a=√39≈6.24")
                                    ]
                                },
                                {
                                    id: "e2",
                                    q: t("Tam giác: a=7, b=5, c=6. Tính góc A.", "Triangle: a=7, b=5, c=6. Find angle A."),
                                    a: [
                                        t("cosA=(b²+c²−a²)/(2bc)=(25+36−49)/(2·5·6)=12/60=1/5", "cosA=(25+36−49)/60=1/5"),
                                        t("A=arccos(1/5)≈78.46°", "A≈78.46°")
                                    ]
                                },
                                {
                                    id: "e3",
                                    q: t("Tam giác a=3, b=4, c=5. Là tam giác gì?", "Triangle: a=3, b=4, c=5. What type?"),
                                    a: [
                                        t("c²=25; a²+b²=9+16=25", "c²=25; a²+b²=25"),
                                        t("Vì c²=a²+b² → C=90° → TAM GIÁC VUÔNG!", "c²=a²+b² → C=90° → RIGHT triangle!")
                                    ]
                                }
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$duosteam$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_64d5eeabc3e5d7da937e2327328eb8d4$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        t("Bài 11 / Chương IV", "Lesson 11 / Chapter IV")
                    ]
                }, void 0, true, {
                    fileName: "[project]/duosteam/src/components/Cacbaitoan10/Lesson10_DinhLiCosin.js",
                    lineNumber: 242,
...
//# sourceMappingURL=duosteam_src_components_d4eccb51._.js.map